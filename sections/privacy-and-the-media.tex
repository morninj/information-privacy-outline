...
\begin{enumerate}
    ...
    information is to be disseminated beyond a particular group. For instance, 
    someone can retain an interest in his HIV positive status even if 60 others 
    (friends, family, doctors, support group members) knew about 
    it.\footnote{Casebook pp. 118--19.}
\end{enumerate}
